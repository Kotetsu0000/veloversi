...
```bash
uv add "https://github.com/Kotetsu0000/veloversi/releases/download/v0.2.3/veloversi-0.2.3-cp312-abi3-manylinux_2_34_x86_64.whl"
```

### Linux aarch64

```bash
uv add "https://github.com/Kotetsu0000/veloversi/releases/download/v0.2.3/veloversi-0.2.3-cp312-abi3-manylinux_2_34_aarch64.whl"
```

### macOS Intel

```bash
uv add "https://github.com/Kotetsu0000/veloversi/releases/download/v0.2.3/veloversi-0.2.3-cp312-abi3-macosx_10_12_x86_64.whl"
```

### macOS Apple Silicon

```bash
uv add "https://github.com/Kotetsu0000/veloversi/releases/download/v0.2.3/veloversi-0.2.3-cp312-abi3-macosx_11_0_arm64.whl"
```

### Windows x86_64

```powershell
uv add "https://github.com/Kotetsu0000/veloversi/releases/download/v0.2.3/veloversi-0.2.3-cp312-abi3-win_amd64.whl"
```
...
```bash
uv add "https://github.com/Kotetsu0000/veloversi/releases/download/v0.2.3/veloversi-0.2.3.tar.gz"
```
