...
def prepare_cnn_model_input(board_or_record: Board | dict[str, object]) -> np.ndarray: ...
def prepare_cnn_model_input_batch(
    values: list[Board | dict[str, object]],
) -> np.ndarray: ...
def prepare_flat_model_input(board_or_record: Board | dict[str, object]) -> np.ndarray: ...
def prepare_flat_model_input_batch(
    values: list[Board | dict[str, object]],
) -> np.ndarray: ...
